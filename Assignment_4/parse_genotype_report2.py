# -*- coding: utf-8 -*-
"""
Usage: (python) parse_genotype_report2.py sample2geno.txt <.xml files>
...
if __name__ == '__main__':
    if len(sys.argv) != 1:
        ...
        print 'Usage: (python) parse_genotype_report2.py sample2geno.txt <.xml files>'
        print 'Example: \
            python parse_genotype_report2.py sample2geno.txt ncbi_genotype_report2.xml'